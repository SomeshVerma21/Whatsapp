...
import com.vermaji.whatsapp.databinding.ActivitySignInBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.idBtnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.show();
                auth.signInWithEmailAndPassword(binding.idEmail.getText().toString(),binding.idPassword.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    @Override
        ...
        binding.idBtnGoogleSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                signIn();
            }
